...
CORESHARED_EXPORT Elem* getData_InPos(Protocol *protocol,int curCnt,int allCnt,bool isFilter);
...
struct CORESHARED_EXPORT ByteData:public Elem{///字节数据
...
struct CORESHARED_EXPORT BitData:public Elem{///位数据
    /*!！！！ 位数据暂时默认不超过1字节*/
